                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="companyname" name="companyname" value="{{$data->companyname}}" class="form-control form-control-lg"
                                        placeholder="User Name" >
                                        <label id="company_name_error" style="color:red;display:none">Company Name Is Required</label>
                                </div>
