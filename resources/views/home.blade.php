                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-xxl-4">
                                        <div class="mb-3"><label class="form-label text-primary" for="license_allowed_activations"><strong>Allowed Activations</strong></label><input class="form-control" type="number" placeholder="0" name="license_allowed_activations" min="1" max="1000000" required=""></div>
                                    </div>
                                    <div class="col-12">
